...
def run_evr_query_with_type():
    ...
    res = requests.get(url, 
        json= {
            'sessionId': sessionId, 
            'evrName': 'IO_UPL_LOCK', 
            'evrType': ['FSW_REALTIME', 'FSW_RECORDED'],
            'startTime': query_start_time,
            'endTime': query_end_time
        },
        headers=exec_shared_dict['headers'],
...
def run_evr_query_multi_with_type():
    utc_now = datetime.now(tz=timezone.utc)
    ...
    print('query CHILL evr')
    url = f'{server}/evr/chill_multi'

    res = requests.get(url, 
        json= {
            'sessionId': sessionId, 
            'evrNames': [CMD_COMP_EVR, 'IO_UPL_LOCK'], 
            'evrType': ['FSW_REALTIME', 'SSE'],
            'startTime': query_start_time,
            'endTime': query_end_time
        },
...
if __name__ == '__main__':    
    ...
    # run_wildcard_query()
    # run_evr_query_with_type()
    # run_evr_multi_query()
    run_evr_query_multi_with_type()